...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email){
        ...
        while (itr.hasNext()) {
            ...
            dtm.addRow(new Object[]{userObj.getId(), userObj.getName(), userObj.getEmail(), userObj.getAddress(),userObj.getMobileNumber(),userObj.getSecurityQuestion(), userObj.getStatus()});
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1274, 26, 35, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Search ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(412, 135, -1, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(504, 132, 376, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(63, 185, 1224, 468));

        jLabel3.setFont(new java.awt.Font("Algerian", 0, 24)); // NOI18N
        jLabel3.setText("*Click on row to change status");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(461, 688, -1, -1));
